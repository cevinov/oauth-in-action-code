...
app.post("/approve", function (req, res) {
  ...
  if (req.body.approve) {
    // Since we’re implementing the authorization code grant type, we’re going to look for the response_type value to be set to code
    if (query.response_type == "code") {
      ...
      var urlParsed = buildUrl(query.redirect_uri, {
        code: code,
        state: query.state, // state parameter is important for preventing CSRF attacks
      });
